...
一个提案只要能进入 Stage 2，就差不多肯定会包括在以后的正式标准里面。ECMAScript 当前的所有提案，可以在 TC39 [TC39官网的官方网站查看。](Github.com/tc39/ecma262)
...
各大浏览器的最新版本，对 ES6 的支持可以查看随着时间的推移，支持度已经越来越高了，超过 90%的 ES6 语法特性都实现了。

[兼容性](kangax.github.io/es5-compat-table/es6/。)
...
我写了一个工具 ES-Checker，用来检查各种运行环境对 ES6 [查看兼容性的支持情况。访问，可以看到您的浏览器支持](ruanyf.github.io/es-checker) ES6 的程度。运行下面的命令，可以查看你正在使用的 Node 环境对 ES6 的支持程度。
